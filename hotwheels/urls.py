...
from aluguel.views import Home, CarrosListView, CarroPage, RegistrationView, CriarUsuario, PerfilUsuario, AtualizarUsuario, CriarContrato, alugar_carro, Criar_Contrato
...
urlpatterns = [    
    ...
    path('contratar_dois/', Criar_Contrato, name='contratarr'),
